...
import com.klikpeta.suko.service.QuestionService;
...
public class QuestionResource {
    ...
    @Timed
    public ResponseEntity<List<QuestionDTO>> searchQuestions(@RequestParam String query, @ApiParam Pageable pageable)
        throws URISyntaxException {
